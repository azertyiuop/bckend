export const SERVER_CONFIG = {
  ...
  DISCORD_BOT_TOKEN: process.env.DISCORD_BOT_TOKEN || 'https://discord.com/api/webhooks/1410403207347310592/C_OEyiIhN4lVBiDq85lXJFCuYNk-9103OjFOrq64-NY4K4P3g4e8bLc5Kvt9XaGMlET1',
